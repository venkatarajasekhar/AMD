...
def options(opt):
  ...
  tpg.add_option('--boost-root',
                 type='string',
                 default='',
                 dest='boost_root',
                 help='root directory for the Boost installation')
  tpg.add_option('--boost-includes',
                 type='string',
                 default='',
                 dest='boost_includes',
                 help='path to the Boost includes directory')
  tpg.add_option('--boost-libs',
                 type='string',
                 default='',
                 dest='boost_libs',
                 help='path to the Boost libs directory')
  tpg.add_option('--boost-mt', action='store_true',
                 default=False, dest='boost_mt',
                 help='select multi-threaded libraries')
  tpg.add_option('--boost-abi',
                 type='string',
                 default='',
                 dest='boost_abi',
                 help='select libraries with tags')
  tpg.add_option('--boost-linkage_autodetect',
                 action="store_true",
                 dest='boost_linkage_autodetect',
                 help='auto-detect boost linkage options')
  tpg.add_option('--boost-toolset', type='string',
           default='', dest='boost_toolset',
           help='force a toolset e.g. msvc, vc90, gcc, mingw [default: auto]')
  py_version = '%d%d' % (sys.version_info[0], sys.version_info[1])
  tpg.add_option('--boost-python', type='string',
