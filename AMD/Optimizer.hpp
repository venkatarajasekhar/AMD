 ...
 * @file Optimizer.hpp
 *
 * @author Peder Olsen, Anju Kambadur, Wuwei Zhang, Allan Sapucaia Barboza
 *
 * @brief This file defines optimization related functions for SymbolicScalarMatlab class and 
